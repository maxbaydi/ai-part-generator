...
DEFAULT_ENHANCER_MODEL = "anthropic/claude-haiku-4.5"
...
DEFAULT_SMOOTHING_MIN_STEP = "1/32"
DEFAULT_SMOOTHING_WRITE_EVERY_STEP = True
...
WIND_BRASS_MAX_NOTE_DUR_Q = 8.0
WIND_BRASS_FAMILIES = {"woodwinds", "brass", "winds"}
STRINGS_MAX_NOTE_DUR_Q = 8.0
STRINGS_FAMILIES = {"strings"}
MAX_NOTE_DUR_Q_DEFAULT = 8.0
ARRANGEMENT_MAX_NOTE_DUR_BARS = 2.0
